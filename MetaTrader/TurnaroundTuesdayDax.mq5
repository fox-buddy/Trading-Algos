...
#property description "Turnaround Tuesday Dax Index"
...
void OnTick()
{
	...
	if(newBar == true)
	{
      ...
      TimeToStruct(TimeCurrent(), timeVar);
		...
		if (timeVar.day_of_week == 1)
      {
          if(timeVar.hour == 22 && timeVar.min == 00) {
      ...
      if (timeVar.day_of_week == 3)
      {
          if(timeVar.hour == 9 && timeVar.min == 00) {
